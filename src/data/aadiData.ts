...
export const galaxyNodes: GalaxyNode[] = [
  ...
  },
  {
    ...
    bullets: [
      'Venture-backed go-to-market seat',
      'Positioning and growth systems',
      'Bay Area operator work',
    ],
    date: 'June 2026 – Present',
    impact: 'Venture-backed Go-To-Market',
    logo: './images/corgi-logo.png',
    ...
    orbitHeight: -0.3,
    model: './models/planet-techno.glb',
    links: [
  ...
  },
  {
    ...
    subtitle: 'Campus Planet · Honor Society',
    body: 'President of Alpha Gamma Sigma Honor Society — leading campus honors, finance ops, and scholarship infrastructure.',
    bullets: [
      'President, Alpha Gamma Sigma Honor Society',
      'ICC · Rotary · AGS finance ops',
      'Scholarship infrastructure for CC students',
    ],
    date: '2025 – Present',
    impact: 'AGS President · Campus leadership',
    logo: './images/ags-seal.png',
    ...
    orbitHeight: 0.2,
    hasRing: true,
    model: './models/planet-jupiter-baxter.glb',
    links: [
...
export const overviewCameraPos: [number, number, number] = [3.55, 1.15, 3.85];
export const overviewLookAt: [number, number, number] = [0, 0.15, 0];
